...
covnat <- read_csv(here("lecture_slides/99_data_communication_dash_poster/data","covdata.csv"))
load(here("lecture_slides/99_data_communication_dash_poster/data","nytexcess.rda"))
```
...
![[Template](https://github.com/davi-moreira/2025S_data_mining_lab_purdue_MGMT173/raw/refs/heads/main/docs/lecture_slides/99_data_communication_dash_poster/2025S_mgmt474_poster_template.pptx.zip){target="_blank"} and [Rubric](https://www.purdue.edu/undergrad-research/conferences/spring/Rubric_Poster.pdf){target="_blank"}](figs/poster_template.png){width="70%"}
...
![[Template](https://github.com/davi-moreira/2025S_data_mining_lab_purdue_MGMT173/raw/refs/heads/main/docs/lecture_slides/99_data_communication_dash_poster/2025S_mgmt474_poster_template.pptx.zip){target="_blank"}, [Rubric](https://www.purdue.edu/undergrad-research/conferences/spring/Rubric_Poster.pdf){target="_blank"}, and [Video](https://www.youtube.com/watch?v=ReN-QcVTZ1o){target="_blank"}](figs/poster_template.png){width="90%"}
