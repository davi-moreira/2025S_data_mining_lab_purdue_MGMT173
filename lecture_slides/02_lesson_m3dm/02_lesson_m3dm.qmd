...
- Check two business datasets for case studies
    -   `mtcars`
    -   `SalesData.xlsx`
...
# Announcements {background-color="#cfb991"}
...
knitr::include_graphics("figs/baim_association_callout_2024F.png") 
```
...
- **[Business Analytics and Information Management (BAIM) Major](https://business.purdue.edu/undergraduate/academics/business-analytics-and-information-management.php)**: [Plan of study](https://catalog.purdue.edu/preview_program.php?catoid=17&poid=30494&returnto=23140).

- **BAIM Association**: Learn how you can get involved.

    - Tuesday, August 27, 6-7pm, STEW 320
    - Wednesday, August 28, 6-7pm, STEW 320
    - Note: you only need to attend one of the callouts.
...
- A relational database links data tables through pre-defined and
shared fields in various data tables, establishing relationships.

- This permits more efficient organization and utilization of
data across multiple tables. 

- Moreover, a relational database serves as a potent tool for handling extensive data volumes
...
- [Metadata](https://en.wikipedia.org/wiki/Metadata) is essentially information about structured data. It can include details like the date and time a database or file was created, who created it, and what
types of information it contains.

- A [data dictionary](https://en.wikipedia.org/wiki/Data_dictionary) is a more specific type of metadata that describes the structure, content, and format of a dataset. It's like a guidebook and a codebook that provides a comprehensive list of all the variables or columns in a dataset,
...
# Two Business Case Data {background-color="#cfb991"}
...
```{r  echo=FALSE, out.width = "60%",fig.align="center"}
knitr::include_graphics("figs/salesdata_view.png") 
```
...
## Data Dictionary for `SalesData.xlsx`

```{r  echo=FALSE, out.width = "60%",fig.align="center"}
knitr::include_graphics("figs/salesdata_codebook.png") 
```
...
- **Business Case Studies (`mtcars` and `SalesData.xlsx`)**
    - `mtcars` Dataset: Structured data on car specifications, useful for learning data manipulation and statistical analysis.
    - `SalesData.xlsx`: eCommerce sales data, suitable for business analytics case studies.
